...
class BaseLandlordData(BaseData):
    """
    All subclasses to this base class represent a category of data_root operations related to landlord data_root processing
...
class CleanTaxpayer(BaseLandlordData):
    ...
    """
    Subclass for property taxpayer data_root. This class shall contain all logic for cleaning property taxpayer records,
...
class NetworkAnalysis(BaseLandlordData):
    ...
    def process_name_addr_network(
        ...
        # Keep good matches and join back to data_root
