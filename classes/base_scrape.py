...
class BaseScrape(BaseData):
    ...
    def scrape(cls, pin):
        ...
        try:
            ...
            if table:
                ...
                data["Success?"] = False
                data["Error"] = "Building profile data table not found"
                return data
            ...
            if taxpayer_data_url:
                ...
                if taxpayer_div:
                    ...
                    data["Success?"] = False
                    data["Error"] = "Building Taxpayer data table not found"
                    return data
    ...
    def get_count_no_data(cls, path_to_failures, zip_):
        ...
        if file_to_read:
            df = pd.read_csv(file_to_read)
            df_no_data = df[df["Error"] == "Building profile data table not found"]
